...
def predict():
    if request.method == 'POST':
        ...
        if(Gender_Male == 'Male'):
            ...
            Gender_Male = 0
            Gender_Female = 1
        prediction = xgb.predict([[CreditScore,Age,Tenure,Balance,NumOfProducts,HasCrCard,IsActiveMember,EstimatedSalary,Geography_Germany,Geography_Spain,Gender_Male]])
        if prediction==1:
